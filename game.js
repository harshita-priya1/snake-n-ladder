...
let totalSnakes = readlineSync.question("Enter the number of snakes:");
...
for (let i = 0; i < totalSnakes; i++) {
  ...
  SnLBoard.addSnakes([head, tail]);
}

let totalLadders = readlineSync.question("Enter the number of Ladders:");
...
for (let i = 0; i < totalLadders; i++) {
  ...
  SnLBoard.addLadders([start, end]);
}

let totalPlayers = readlineSync.question("Enter the number of Players:");
